...
try:
    ...
    gun_shot_sound = mixer.Sound('pewpew.wav')  # Added gun shot sound
except:
    class DummySound:
        def play(self): pass
    jump_sound = coin_sound = hurt_sound = powerup_sound = shoot_sound = gun_shot_sound = DummySound()
...
class Player(pygame.sprite.Sprite):
    ...
    def shoot(self, all_sprites):
        if self.shoot_cooldown == 0:
            ...
            gun_shot_sound.play()  # Play the gun shot sound
...
def create_level(level_num):
    ...
    all_sprites.add(player.gun)  # Add gun to all_sprites
